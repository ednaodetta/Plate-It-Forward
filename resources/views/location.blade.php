...
<body class="bg-DefaultWhite h-full">
    ...
    <div
        class=" bg-bglocation relative  bg-no-repeat bg-cover bg-center h-56 sm:h-64 md:h-80 flex flex-col justify-center items-center text-center">
    </div>
    ...
    @if ($selectedCity)
        <div class="wrapper h-full">
            <div class="mt-8 mb-6 flex justify-center flex-col items-center">
                <h1 class="text-sm sm:text-sm text-gray-800 font-brandon w-[82%]"><a href='/restoranpage'>Beranda</a> /
                    {{ $selectedCity }}</h1>
                <h2 class="text-3xl sm:text-4xl font-semibold text-gray-800 font-brandon w-[82%]">{{ $selectedCity }}
                </h2>
            </div>
                            ...
                            <a href="{{ route('menupage', ['id' => $item->id]) }}">
                                <div
                                    ...
                                    <img class="w-full h-48 object-cover"
                                        src="https://i.ytimg.com/vi/QiZt1ALYVEQ/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCvsiWPunf-Yh1MTqZcv8sGKooajw"
                                        alt="Martabak">
                                    <div class="p-4">
