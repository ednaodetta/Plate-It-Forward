            ...
            <nav id="menu"
                ...
                <ul class="flex flex-col lg:flex-row lg:space-x-10 text-gray-600">
                    ...
                    <li><a href="/restoranpage"
                            class="block px-6 py-3 hover:text-Teal hover:bg-gray-100">Restaurants</a>
                    </li>
                    <li><a href="/my-donations" class="block px-6 py-3 hover:text-Teal hover:bg-gray-100">My
                            Donations</a>
                    </li>
                    <li><a href="/contact-us" class="block px-6 py-3 hover:text-Teal hover:bg-gray-100">Contact Us</a>
                    </li>
                    <li>
...
>>>>>>> 58f1611408f5922e1fe3c911f83adb3ccef9fb7a
            ...
            <div class="w-full flex flex-col items-center gap-3 ">
                ...
                <div class="cardlistnye bg-[#f9f3f0] w-[85%] flex gap-[40px] flex-wrap justify-between items-center">
                    <div
                        class="card border-2 bg-DefaultWhite w-[350px] h-[420px] rounded-[10px] shadow-[1px_1px_1px_#666] p-5 ">
                        <img class="h-[80%] w-full"
                            ...
                            alt="PaNas 1 Ayam McD Gulai Spicy" onclick="buttonmenudesc()">
                        <h1 class="font-bold text-[20px]">Panas 1 Ayam MCD Gulai Spicy</h1>
                        <div class="flex justify-between">
                            <h1>42.500</h1>
                            <button class="w-[100px] rounded-md bg-DefaultGreen font-bold text-white">ADD</button>
            ...
            <button
                ...
                onclick="buttonmenu()">cart</button>
        </div>
        ...
        <!-- desc part -->
        <div
            class="desc bg-DefaultWhite flex-col h-[100vh] fixed items-center right-0 justify-between  hidden w-[28%]">
